...
<div class="stats panel"><?php $key = 'stats-coo-'.$stats->character->characterId; ?>
	<table class="table table-condensed table-striped">
		<thead>
		<tr>
			<th class="header" colspan="3"><i class="fa fa-trophy"></i> Court of Oryx</th>
		</tr>
		</thead>
		<tbody id="<?= $key ?>">
		<tr>
			<td class="header" colspan="2">Tier 1 Completions</td>
			<td><?= $pve->courtOfOryxWinsTier1->formattedValue ?></td>
		</tr>
		<tr>
			<td class="header" colspan="2">Tier 2 Completions</td>
			<td><?= $pve->courtOfOryxWinsTier2->formattedValue ?></td>
		</tr>
		<tr>
			<td class="header" colspan="2">Tier 3 Completions</td>
			<td><?= $pve->courtOfOryxWinsTier3->formattedValue ?></td>
		</tr>
		</tbody>
	</table>
</div>
