...
@section('content')
    ...
    <div>
        ...
        <p>This Privacy Policy governs the manner in which Destiny Status. collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="//destinystatus.com">destinystatus.com</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by Destiny Status.</p>
        ...
        <p>Destiny Status. may collect and use Users personal information for the following purposes:
        ...
        <p>Destiny Status. has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        ...
        <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at: <a href="mailto:privacy@tracker.network">privacy@tracker.network</a><p>

        <p>This document was last updated on September 02, 2016</p>
    </div>
@stop