...
class DestinyManifestCommand extends Command
{
	 ...
	 * @var string
	 */
	protected $name = 'destiny:manifest';
	...
	{
		return array(
			array('extract', 'e', InputOption::VALUE_NONE, 'Extract manifest.', null),
			array('download', 'd', InputOption::VALUE_NONE, 'Force download and extract manifest.', null),
		);
	}
	...
	public function fire()
	{
		...
		$this->versionFile = app_path('database/manifest/.version');
		$this->versionDb = app_path("database/manifest/$this->version.sqlite");
	...
	protected function download()
	{
		...
		$tmp = storage_path("cache/$this->version.zip");
	...
	{
		$path = app_path("database/manifest/$folder");
